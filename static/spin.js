...
overlay.style.cssText =   position: fixed;   top: 0;   left: 0;   width: 100%;   height: 100%;   background: rgba(0,0,0,0.9);   z-index: 10000;   display: flex;   align-items: center;   justify-content: center;   color: white;   font-family: Arial, sans-serif;  ;
...
// Reset UI elements  
            ...
            document.getElementById('spinsLeft').textContent = '15';  
            document.getElementById('todayEarnings').textContent = '₹0.00';  
            document.getElementById('totalEarnings').textContent = '₹0.00';  
            document.getElementById('dailyEarnings').textContent = '₹0.00';  
              
            // Hide scratch card if visible  
            document.getElementById('scratchContainer').style.display = 'none';  
